...
function Adminlist4 (props)  {

    function handleClick() {
        console.log('Button click ...');
        console.log(props._id) 

        axios.delete(`http://165.22.208.232:5000/admin/user/delete/${props._id}`, {
        // axios.get(`admin/user/delete/${props._id}`, {
            headers: {
    ...
    return (   
                ...
                <div className="item col-md-4 col-sm-8" style={{textAlign:'left', border:'solid', marginRight:'2%',marginBottom:'2%', marginTop:'2%', paddingTop:'3%', borderRadius:'10px', backgroundColor:'white'}}>
